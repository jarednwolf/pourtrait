    ...
    <section aria-labelledby="faq-heading" className="py-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <article className="rounded-lg border border-gray-200 p-4 bg-white">
          ...
          <a href="/chat?q=What%20pairs%20with%20salmon%3F" className="text-sm text-purple-700 mt-2 inline-block">Ask the Sommelier</a>
        </article>
        <article className="rounded-lg border border-gray-200 p-4 bg-white">
          ...
          <a href="/chat?q=Recommend%20a%20wine%20under%20%2425" className="text-sm text-purple-700 mt-2 inline-block">See suggestions</a>
        </article>
        <article className="rounded-lg border border-gray-200 p-4 bg-white">
          ...
          <a href="/settings" className="text-sm text-purple-700 mt-2 inline-block">Configure alerts</a>
        </article>
      </div>
    </section>
  )
